...
public class Crawler {
    ...
    public static void main(String[] args) {
        ...
        //Установить пару нулевой глубины
        URLDepthPair currentDepthPair = new URLDepthPair("http://ege.edu.ru/ru/special/main/");
        ArrayList<String> seenURLs = new ArrayList<String>();
        seenURLs.add(currentDepthPair.getURL());

        URLPool pool = new URLPool(2); //хранит список всех URL-адресов для поиска, а также уровень (глубину поиска)
